...
sleep 2
tar zxvf cmake-2.8.12.1.tar.gz && cd cmake-2.8.12.1 && ./configure --prefix=/usr && make && make install || exit 1
echo 'OK,cmake-2.8.12.1 has  been successfully installed!'
...
sleep 2
tar zxvf re2c-0.13.6.tar.gz && cd re2c-0.13.6 && ./configure && make && make install || exit 1
